...
import 'package:news_app/DeveloperInfo.dart';
...
class _HomeState extends State<Home> {
  ...
  getNewsofIndia() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=in&apiKey=aff481ff9594444fba02e5a8b9c54e53";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
